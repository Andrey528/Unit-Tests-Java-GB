...
*/
    ...
    void priceCartIsCorrectCalculated() {
        ...
        assertThat(cart.getTotalPrice()).isEqualTo(370.0);
    }
    ...
    void priceCartProductsSameTypeIsCorrectCalculated() {
        ...
        // Assert
        assertThat(cart.getTotalPrice()).isEqualTo(510.0);
    }
    ...
    void incorrectProductSelectionCausesException(int i) {
        assertThatThrownBy(() -> cart.addProductToCartByID(i)).isInstanceOf(RuntimeException.class).describedAs("Не найден продукт с id: " + i);
    }
    ...
    void incorrectProductRemoveCausesException() {
        assertThatThrownBy(() -> cart.removeProductByID(0)).isInstanceOf(RuntimeException.class).describedAs("Не найден продукт с id: 0");
    }
