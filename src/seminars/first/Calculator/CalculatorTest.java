...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(64.5, 300)
        ).isInstanceOf(ArithmeticException.class);

        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(0.001, 30)
        ).isInstanceOf(ArithmeticException.class);

        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(64.5, -10)
        ).isInstanceOf(ArithmeticException.class);

        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(Double.MAX_VALUE, 30)
        ).isInstanceOf(ArithmeticException.class);
    }
}